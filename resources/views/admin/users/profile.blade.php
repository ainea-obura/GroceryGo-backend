            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Fisrt Name</label>
                      <input id="inputTitle" type="text" name="name" placeholder="First name"  value="{{$profile->fname}}" class="form-control">
                      @error('name')
                      ...
                      <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="lname" placeholder="Last name"  value="{{$profile->lname}}" class="form-control">
                        @error('name')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
